package shape_comparator.views;
...
import shape_comparator.views.compareshapes.CompareShapesView;
import shape_comparator.views.graphs.GraphsView;
import shape_comparator.views.shapes.ShapesView;
import shape_comparator.views.versions.VersionsView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("ShapeComparator");
